...
add_project("tarım" , "", "https://tarim-planlama.herokuapp.com/"           , "./images/napsak2.png", "Tarımda Planlama","Devam Ediyor","display:flex;justify-content:center;align-items:center;min-height:200px;","max-width:54%;height:auto")
add_project("website" , "", "https://redstone-2022.herokuapp.com/"           , "./images/redstone.png", "Oto-Kargo","Devam Ediyor","display:flex;justify-content:center;align-items:center;min-height:200px;","max-width:54%;height:auto")